...
// Animation    
	function frame1(){
        ...
        .to([
            '#txt1_container .txt_mask', '#txt2_container .txt_mask', '#txt3_container .txt_mask', '#txt4_container .txt_mask'], {duration:.6,  clipPath:'inset(0 0% 0 0)', stagger:.25, ease: "sine.out"}, 'f1+=1')
