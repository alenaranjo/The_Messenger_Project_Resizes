...
// Animation    
	function frame1(){
        ...
        .add("f1")
        //.to([txt1_container, txt2_container, txt3_container, txt4_container, txt5_container, txt6_container], {duration:.4,  clipPath:'inset(0 0% 0 0)', stagger:.2, ease: "sine.out"}, 'f1+=.4')
        // .to([
        //     '#txt1_container .txt_mask', 
        //     '#txt2_container .txt_mask', 
        //     '#txt3_container .txt_mask', 
        //     '#txt4_container .txt_mask',
        //     '#txt5_container .txt_mask',
        //     '#txt6_container .txt_mask'
        // ], {duration:.6,  clipPath:'inset(0 0% 0 0)', stagger:.25, ease: "sine.out"}, 'f1+=1')
    ...
    function frame2(){
        ...
        .add("f2")
        .to([txt7_container, txt8_container, txt9_container], {duration:.4,  clipPath:'inset(0 0% 0 0)', stagger:.2, ease: "sine.out"}, 'f2+=.4')
        .to(['#txt7_container .txt_mask', '#txt8_container .txt_mask', '#txt9_container .txt_mask'], {duration:.6,  clipPath:'inset(0 0% 0 0)', stagger:.25, ease: "sine.out"}, 'f2+=.8')
        .to(['#txt7_container .txtBg', '#txt8_container .txtBg', '#txt9_container .txtBg'], {duration:.45,  clipPath:'inset(0 0% 0 0)', stagger:.25, ease: "sine.out"}, 'f2+=1.5')
