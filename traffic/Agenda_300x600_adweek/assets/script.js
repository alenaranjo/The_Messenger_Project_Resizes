...
// Animation    
    ...
    function frame2(){
        ...
        .add("f2")
        .to(txt4_container, {duration:.4,  clipPath:'inset(0 0% 0 0)', stagger:.2, ease: "sine.out"}, 'f2+=.4')
        .to('#txt4_container .txt_mask', {duration:.6,  clipPath:'inset(0 0% 0 0)', stagger:.25, ease: "sine.out"}, 'f2+=.8')
        .to('#txt4_container .txtBg', {duration:.45,  clipPath:'inset(0 0% 0 0)', stagger:.25, ease: "sine.out"}, 'f2+=1.5')
