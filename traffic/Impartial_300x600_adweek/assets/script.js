...
// Animation    
    ...
    function frame2(){
        ...
        .add("f2")
        .to([txt4_container, txt5_container, txt6_container, txt7_container, txt8_container], {duration:.4,  clipPath:'inset(0 0% 0 0)', stagger:.2, ease: "sine.out"}, 'f2+=.4')
        .to(['#txt4_container .txt_mask', '#txt5_container .txt_mask', '#txt6_container .txt_mask', '#txt7_container .txt_mask', '#txt8_container .txt_mask'], {duration:.6,  clipPath:'inset(0 0% 0 0)', stagger:.25, ease: "sine.out"}, 'f2+=.8')
